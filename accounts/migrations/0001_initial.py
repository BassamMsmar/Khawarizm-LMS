# Generated by Django 5.2.1 on 2025-05-22 12:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Student'), ('lecturer', 'Lecturer'), ('teaching_assistant', 'Teaching Assistant'), ('admin', 'Admin')], default='student', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('languages', models.ManyToManyField(blank=True, related_name='lecturers', to='accounts.language')),
                ('skills', models.ManyToManyField(blank=True, related_name='lecturers', to='accounts.skill')),
